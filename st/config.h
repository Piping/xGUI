 ...
 */
static char *font = "mono:pixelsize=24:antialias=true:autohint=true:dpi=192";
static char *font2[] = { "JoyPixels:pixelsize=20:antialias=true:autohint=true:dpi=192" };
...
MouseKey mkeys[] = {
	...
	{ Button3,              XK_ANY_MOD,     clippaste,      {.i = 0} },
	{ Button2,		        XK_ANY_MOD,     selpaste,       {.i = 0} },
};
